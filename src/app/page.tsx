...
const POSTS_QUERY = `*[ _type == "directions" ]{_id, title_ru, image, content_ru, order} | order(order asc)`;
...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <AboutUs id={aboutUs.title_ru} img={aboutUs.image} body={aboutUs.content_ru} />
